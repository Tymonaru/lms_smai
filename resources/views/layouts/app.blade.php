  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block ms-3">SMAI Lumajang</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#forms-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-book"></i><span>Pembelajaran</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href='/walisiswa/lihatmateri'>
              <i class="bi bi-circle"></i><span>Lihat Materi</span>
            </a>
          </li>
          <li>
            <a class="nav-link {{ Request::is('walisiswa/lihattugas') ? "" : "collapsed" }}" href="/walisiswa/lihattugas">
              <i class="bi bi-circle"></i><span>Lihat Tugas</span>
            </a>
          </li>
        </ul>
